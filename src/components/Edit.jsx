...
const Edit = () => {
  ...
  let formHandle = (e) => {
    ...
    axios.put(`http://localhost:5000/employee/${obj.abc}`, load)
    ...
    return (
      <div id={style.edit}>
        ...
        <input type="text" value={name} onChange={dname} id="Username" name='Username' placeholder='Username' />

        
        <label htmlFor="Password">Password</label>
        <input type="Password" value={pass}onChange={dpass} id='Password' placeholder='Password' />

        <label htmlFor="email">Email</label>
        <input type="email" value={email} id='email' placeholder='email' onChange={demail} />
